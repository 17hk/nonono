...
@app.on_message(filters.chat(chat_id) & filters.user(1382346231) & filters.regex(pattern='Thank you for using animebot.')):
async def delete_animebot_startmessage(client, message):
    message.delete()

@app.on_message(filters.chat(chat_id) & filters.user(1382346231) & filters.regex(pattern='Join our updates')):
